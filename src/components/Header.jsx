...
return (
    <header>
            <div className="container-fluid collapse" id='navbarToggleExternalContent' >
                <div className='ahmed'>
                    <ul className="navbar-nav ahmed d-flex flex-row">
                        <li className="nav-item">   
                            <a className="nav-link btn poppins"  href="#Contact">Contact</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link btn poppins" href="#Personal-Sklills">Personal Skills</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link btn poppins" href="#Projects"> Projects</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link btn poppins" href="#Education">Education</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link  btn poppins " href="#About-Me">About Me</a>
                    </li>
                    </ul>
                </div>
            </div>
